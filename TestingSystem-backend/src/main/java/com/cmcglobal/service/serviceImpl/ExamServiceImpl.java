...
public class ExamServiceImpl implements ExamService {
	...
	public FilterBuilder getFilterBuilder(Exam exam) {
		return new FilterBuilder.Builder().setNumberOfQuestion(exam.getNumberOfQuestion())
				.setDuration(exam.getDuration()).setCreateAt(exam.getCreateAt()).setStatus(exam.getStatus())
				.setCaterogyName(exam.getCategoryName()).setCreateBy(exam.getRoleName()).builder();
	}
